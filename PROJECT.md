...
2. **教學影片**：**2026-08-25 分家獨立**——整條線（分工、兩條產線、治理、EPxx 腳本）移至 教學影片 repo（`../teaching-videos/`，GitHub `teacherjung/teaching-videos`），進度追蹤改在那邊。本 repo 這側只剩兩件事：①與 app 的交付契約＝`docs/learning-hub-contract.md`（含學習專區 v0 規格）②學習專區／詞彙牆的實作本身（尚未開工，詞彙短片累積 50–100 支後才排）
