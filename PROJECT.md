...
> 最後更新：2026-08-18（教學影片分工 v4：工讀生二人組入列＋詞彙短片量產線）。
...
2. **教學影片**：分工 v4（2026-08-17）取代 2026-07-24 版：Claude 腳本、Grok 查核、**工讀生二人組製作與營運**、Codex 學習專區改「詞彙牆」次階段（累積 50–100 支再開工、測驗留 EPxx）。手冊與看板落腳處＝Notion、與生產看板同處（v4.2）。**下一步的三項待辦（建手冊頁／看板加七欄／挑試產批 10 詞）連同 Notion 座標寫在 `docs/教學影片/製作流程與分工.md` 的「待辦交接」節** — **待 Notion 連接器可用**
