...
> 最後更新：2026-08-04（#335 高風險複審四項收官；D3 瘦身後，本檔只留現在進行式）。
...
2. **教學影片**：學習專區未開工（PR 需一併帶入 `docs/教學影片/` 兩份文件）。分工已議定（2026-07-24 會議，Claude／Codex 共識、與角色分工一致）：Claude 起草腳本＋就地解釋文案，Codex 做 YouTube 嵌入前端 — **暫停**
