...
2. **教學影片**：分工 v4（2026-08-17）取代 2026-07-24 版：Claude 腳本、Grok 查核、**工讀生二人組製作與營運**、Codex 學習專區改「詞彙牆」次階段（累積 50–100 支再開工、測驗留 EPxx）。首務＝詞彙短片試產批 10 支（規則與試產計畫＝`docs/教學影片/製作流程與分工.md`） — **待工讀生到位啟動**
