...
> 最後更新：2026-08-19（教學影片分工 v4：工讀生二人組入列＋詞彙短片量產線）。
...
- **教學影片**：分工 v4（2026-08-17，William 八題問答定稿）＝兩條產線：EPxx 正片線照舊（EP01 腳本仍待老師審）；新設**詞彙短片線**（500 詞、直式 ≤90 秒、複製聲不出臉），**工讀生二人組**承接製作與營運，生產看板＝Notion 財金詞彙庫（規則全文＝`docs/教學影片/製作流程與分工.md`）。
...
2. **教學影片**：分工 v4（2026-08-17）取代 2026-07-24 版：Claude 腳本、Grok 查核、**工讀生二人組製作與營運**、Codex 學習專區改「詞彙牆」次階段（累積 50–100 支再開工、測驗留 EPxx）。手冊與看板落腳處＝Notion、與生產看板同處（v4.2）。開工前置**三項已完工**（Notion 手冊頁、看板七欄＋Board 視圖、試產批 10 詞腳本）；下一步＝**跑試產批 10 支**（工時與手冊看不懂的句子是要交回來的兩樣東西） — **William＋工讀生**
