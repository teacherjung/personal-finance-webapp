...
1. **重啟 app → 重傳 2026/03 台新對帳單 → 確認匯入**（r2 #246＋r3 #247 都已合併；解析已用真檔逐欄驗證過，預期直接跳出 3 筆現賣預覽）；之後其他月份逐份上傳（重複月不會重複入帳） — **William**
