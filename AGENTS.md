...
- **值不值得改**：**審查回饋不無條件全改**。只有三種情況才回頭改——①**考題其實沒在守它宣稱的東西**（假綠）②**註解／題名說了撐不住的保證** ③**真的產線 bug**。其餘一律寫進待辦，**不再為它多開一輪審查**。
  ...
  ⚠️ **審查磨太久的兩道剎車（一條兩款）**（William 2026-09-11 裁，原話逐字「如果沒有錯，就幫我併成一條兩款，內容不動。」——「如果沒有錯」指他先確認的兩件：自評是第 8 輪起、每 7 輪一則；自問表是同一件事的第三輪、跟整支審到第幾輪無關——兩件都對；落點＝⚖️PLACEHOLDER）：兩款管的都是「這支磨太久了」，但觸發點與產出不同——**第一款＝同一件事的第三輪：動手改之前私下答五題，寫進提交說明或逐條處置**；**第二款＝整支第 8 輪起：在磨的那一方在 PR 上公開留一則自評**。兩款的內容照 2026-09-10 的兩條原文搬進來、一字不動，只把互相指路的字改成「第一款／第二款」。
