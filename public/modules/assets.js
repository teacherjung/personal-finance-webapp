...
export async function renderAssets() {
  ...
  view().innerHTML = `
    <div class="page-head">
      ...
      <div class="page-actions"><button class="btn-ghost" id="editTargets">${icon('settings', 16)}設定目標配置</button><button class="btn" id="addAcc">${icon('plus', 16)}新增帳戶</button></div>
    </div>
    ...
    <div class="two-col">
      ...
      <div class="chart-card"><h3>分類配置 vs 目標 <span class="stat-sub" style="font-weight:400;margin:0">（現金・股・債・金・房地產等分類）</span></h3>
