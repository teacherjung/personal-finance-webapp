...
<div class="card" style="margin-bottom:12px;padding:12px 14px">
  ...
  <details style="margin-top:8px">
    ...
    <ul class="muted" style="margin:8px 0 0;padding-left:18px;font-size:12px;line-height:1.9">
      <li>一樣要通過驗算才准匯入：把每一筆的餘額前後扣起來看接不接得上、期末餘額對不對得上概要那一欄。對不上就整份退回。⚠️ 但這只擋得住「**扣不起來**」的錯——萬一金額和餘額一起被抄成剛好自洽的另一組數字，數學是平的、驗算就看不出來。所以下面兩張表還是請你自己看一眼。</li>
      <li>沒東西可驗算的帳戶也不收（例如帳單上根本沒印每一筆的餘額）。這點比內建範本更嚴：內建範本驗不到會照舊放行，AI 讀的驗不到就整份退回。</li>
