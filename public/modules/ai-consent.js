...
<div class="card" style="margin-bottom:12px;padding:12px 14px">
  ...
  <details style="margin-top:8px">
    <summary style="font-size:12px">AI 讀的，跟平常讀的差在哪？</summary>
    <ul class="muted" style="margin:8px 0 0;padding-left:18px;font-size:12px;line-height:1.9">
      <li>一樣要通過驗算才准匯入，卡片是兩道：①<b>應繳等式</b>——上期應繳 −已繳退款 ＋本期新增 ＋帳單上有名字的調整項（利息、年費…），要對得上本期應繳；②<b>逐筆加總</b>——明細加起來要對得上帳單自己印的摘要（退款折進「本期新增」或算進「已繳款退款」桶，兩種常見印法都認得；繳款列另外對「已繳款」桶）。任何一道對不上就整份退回、分毫不差才收，比內建範本更嚴。帳單上有名字的調整項（利息、年費…）<b>會一併記進帳</b>（日期用該列印的日期，沒印就用帳單期別）——在下面清單裡照樣可勾選、可改分類。</li>
