...
<div class="card" style="margin-bottom:12px;padding:12px 14px">
  ...
  <details style="margin-top:8px">
    ...
    <ul class="muted" style="margin:8px 0 0;padding-left:18px;font-size:12px;line-height:1.9">
      ...
      <li>⚠️ <b>這些驗算看不到的（不只這些）</b>：①<b>日期或店名讀錯</b>——金額全對、驗算照過，但那兩欄是「這筆有沒有匯過」的辨識依據，下次重匯同一份帳單時可能被當成新的一筆再記一次 ②帳單用了我們沒看過的繳款字眼＝繳款列被當成消費算進加總，通常整份被<b>誤擋</b>（不會誤收）③<b>兩筆正負剛好抵銷的交易一起漏抄</b>（例如 +100 的消費和 −100 的退款）——加總不變、等式照平，三道防線都看不到 ④摘要與明細<b>整組</b>被抄成帳單他處恰好印過、又剛好自洽的另一組數字——同樣看不到 ⑤<b>退款和繳款在同一個合計桶裡互抄</b>——負數列算繳款還是退款，是看 AI 抄回來的說明文字判定的；驗算已把「明細對摘要」升級成擋（抄錯身分跨到別的桶＝整份退回），但帳單把繳款與退款印在**同一個**「已繳款＋退款」合計時，桶內身分對調不改變任何合計、驗算分不出——抄錯時退款會被當繳款<b>不匯入</b>，請特別看一眼狀態欄標「繳款」的列是不是真的繳款。所以上面那行「請確認」還是要請你自己看一眼。</li>
