...
<details>
  ...
  <ul style="margin:8px 0 0;padding-left:18px;line-height:1.9">
    ...
    ${card
    ? `<li>信用卡帳單走<b>單讀</b>：先讀一次，讀出來對不平才換更強的模型再讀一次（讀取費用一發起跳、最多兩發）。讀出來的每一筆會先跟帳單自己印的合計<b>逐筆驗算</b>，對不上就整份不收。匯入成功後會<b>再花一發</b>試著把這個版面學成規則卡——學成之後同版面的帳單就<b>免費</b>、也不再外送；沒學成會告訴你，下期照舊用 AI 讀。</li>`
