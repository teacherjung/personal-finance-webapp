...
<div class="card" style="margin-bottom:12px;padding:12px 14px">
  ...
  <details style="margin-top:8px">
    ...
    <ul class="muted" style="margin:8px 0 0;padding-left:18px;font-size:12px;line-height:1.9">
      ...
      <li>⚠️ <b>這些驗算看不到的（不只這些）</b>：①<b>日期或店名讀錯</b>——金額全對、驗算照過，但那兩欄是「這筆有沒有匯過」的辨識依據，下次重匯同一份帳單時可能被當成新的一筆再記一次 ②帳單用了我們沒看過的繳款字眼＝繳款列被當成消費算進加總，通常整份被<b>誤擋</b>（不會誤收）③<b>兩筆正負剛好抵銷的交易一起漏抄</b>（例如 +100 的消費和 −100 的退款）——加總不變、等式照平，三道防線都看不到 ④摘要與明細<b>整組</b>被抄成帳單他處恰好印過、又剛好自洽的另一組數字——同樣看不到 ⑤<b>繳款和退款的身分抄錯</b>——負數列算哪種，是看 AI 抄回來的說明文字判定的。驗算擋得住其中一型（退款被抄成繳款、而退款原本折在「本期新增」裡＝金額立刻對不上）；<b>擋不住</b>另一型：繳款被抄成退款、金額又恰好等於「已繳款」合計（最常見的整筆繳卡款正是這樣）——算術上與真退款分不出來，會被當成消費抵減匯入。遇到這種形（明細沒有繳款列、卻有退款列）畫面會另外提醒；請看一眼負數的列：標「繳款」的要真的是繳款、大額退款要真的是退款。所以上面那行「請確認」還是要請你自己看一眼。</li>
