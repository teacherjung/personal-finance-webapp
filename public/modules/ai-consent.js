...
<div class="card" style="margin-bottom:12px;padding:12px 14px">
  ...
  <details style="margin-top:8px">
    <summary style="font-size:12px">AI 讀的，跟平常讀的差在哪？</summary>
    <ul class="muted" style="margin:8px 0 0;padding-left:18px;font-size:12px;line-height:1.9">
      <li>一樣要通過驗算才准匯入，卡片是兩道：①<b>應繳等式</b>——上期應繳 −已繳退款 ＋本期新增 ＋帳單上有名字的調整項（利息、年費…），要對得上本期應繳；②<b>逐筆加總</b>——每一筆消費加起來，要對得上帳單自己印的「本期新增款項」（繳款列不計入）。任何一道對不上就整份退回，比內建範本更嚴。⚠️ 帳單上有名字的調整項（利息、年費…）<b>只拿來驗算、不會記進消費明細</b>——要記它們請另外手動記帳。</li>
      <li>另有一道<b>接地檢查</b>：答案上的每個金額都要在帳單上找得到自己的位置，AI 自己算的、猜的數字進不來（日期與店名刻意不查——民國年換算後字面就不同了）。</li>
      <li>⚠️ <b>這些驗算看不到的（不只這些）</b>：①<b>日期或店名讀錯</b>——金額全對、驗算照過，但那兩欄是「這筆有沒有匯過」的辨識依據，下次重匯同一份帳單時可能被當成新的一筆再記一次 ②帳單用了我們沒看過的繳款字眼＝繳款列被當成消費算進加總，通常整份被<b>誤擋</b>（不會誤收）③<b>兩筆正負剛好抵銷的交易一起漏抄</b>（例如 +100 的消費和 −100 的退款）——加總不變、等式照平，三道防線都看不到 ④摘要與明細<b>整組</b>被抄成帳單他處恰好印過、又剛好自洽的另一組數字——同樣看不到 ⑤<b>退款被抄成繳款字樣</b>（或反過來）——負數列算繳款還是退款，是看 AI 抄回來的說明文字判定的；抄錯時那筆退款會被當繳款<b>不匯入</b>，請特別看一眼狀態欄標「繳款」的列是不是真的繳款 ⑥<b>1 元以內的出入</b>——驗算為吸收去尾差留了 1 元容差，恰好差 1 元的漏抄或多抄一筆（例如把頁碼「1」抄成金額）兩道閘都看不出來。所以上面那行「請確認」還是要請你自己看一眼。</li>
