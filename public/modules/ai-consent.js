...
<div class="card" style="margin-bottom:12px;padding:12px 14px">
  ...
  <details style="margin-top:8px">
    ...
    <ul class="muted" style="margin:8px 0 0;padding-left:18px;font-size:12px;line-height:1.9">
      ...
      <li>⚠️ <b>這道驗算看不到的四件事</b>：①每個帳戶的<b>第一筆</b>沒有前一筆可比，金額與方向驗不到 ②<b>外幣</b>明細不在這道驗算裡（它們本來就不計入台幣收支；外幣帳戶的餘額仍會照帳單更新）③<b>這期沒有往來的帳戶</b>（明細裡一筆都沒有、只出現在概要）——它的餘額仍會照帳單更新或新建帳戶，但那個數字沒有任何明細可以驗 ④萬一金額和餘額一起被抄成剛好自洽的另一組數字，數學是平的、驗算就看不出來。所以下面兩張表還是請你自己看一眼，尤其是上面那張「帳戶餘額」。</li>
