...
export async function renderPortfolio() {
  ...
  view().innerHTML = `
    ...
    ${portfolioSummaryHtml({ total, totalCost, totalPnl, eqV, bondV, cashV, goldAll, allBase, leverage, netEquity, loanTwd, levCap: CAPS.lev, missingFx, defaultFx }, { escapeHtml: esc, formatMoney: MONEY })}
