...
export const MISSING_FX_INFO_TITLE = '有外幣部位沒有匯率';
export const MISSING_FX_INFO_HTML = `<p>英鎊、日圓兌台幣的匯率，是在<b>投資頁按「更新報價」</b>時抓回來的。還沒有匯率之前，這些外幣帳戶與持股<b>不會算進淨資產與配置</b>（槓桿只有在沒有 IB 官方淨值摘要、需要自算時才受影響）。</p>
<p>方向要分清楚：缺的是<b>資產</b>，淨資產會比實際<b>少</b>；缺的是<b>負債</b>，負債會比實際<b>小</b>、淨資產<b>可能</b>比實際<b>高</b>（缺的若是 IB 融資的外幣負現金、且沒有 IB 官方淨值摘要而要自算槓桿時，槓桿也會被低估）——這一種最危險，提醒會用紅色講出來。</p>
