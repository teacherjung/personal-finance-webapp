...
// ---- 第二輪稽核（2026-09-02）「route-helpers 整檔」：asyncRoute（core/crud 25 個路由在用）與 wrapRoute 的 extra 原本零考題——
//      把 asyncRoute 改成 sendRouteError（偷改整批路由的錯誤口徑）、wrapRoute 丟掉 extra，本檔 4/4 仍綠。以下兩題釘行為。
