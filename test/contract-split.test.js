...
const MANIFEST = {
  ...
  'docs/contracts/income-expense.md': {
    ...
    files: [
      ...
      'lib/progress-stages.js', 'public/modules/progress-text.js', 'test/upload-progress.test.js', 'lib/parse-recipe.js', 'test/parse-recipe.test.js', 'test/parse-recipe-store.test.js', 'test/recipe-gen.test.js', 'test/ai-dual-read.test.js', 'test/ai-pipeline-interception.test.js', 'test/cd-split.test.js',
      'lib/derive.js',
      'lib/pdf-isolate.js',
      'lib/repo.js',
      'lib/routes/core.js',
