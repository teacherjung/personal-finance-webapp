...
test('★發卡行清單化：相對 base 的行為改變**逐項**釘住（Codex #520 r1#4）', async () => {
  ...
  //    拿掉 `issuerNameKey` 的去空白，本題 48 題全綠（只有表單那三題會紅）⇒ 它對 `issuerBank` 零 delta。
