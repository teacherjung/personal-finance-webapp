...
// 負債型帳戶白名單——與 public/modules/portfolio-exposure.js 的同名複本同步維護。
// ⚠️ 新增型別要改**三處**（原本這裡寫「改其一要改兩處」，漏掉第三處；#409 r5 Codex 抓到）：
//    ①本檔 ②public/modules/portfolio-exposure.js ③lib/schema.js 的 FIELD_SCHEMA.accounts.type 枚舉
//    （那行註解寫明「合法值＝表單 ACCOUNT_TYPES ∪ derive 的 LIABILITY_TYPES」）。
//    漏掉③的下場：新型別在①②都算得出負債，使用者一按儲存卻過不了櫃檯——
