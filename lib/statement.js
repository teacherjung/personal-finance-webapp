...
const CATEGORY_RULES = [
  ...
  ['身心', '運動課程', ['攀岩', '運動中心', '游泳池', '瑜珈', '皮拉提斯', '拳擊', '飛輪']],
  ...
  ['飲食', '餐廳', ['餐廳', '餐飲', '石二鍋', '鼎泰豐', '麥當勞', '肯德基', '摩斯', '漢堡', '火鍋', '燒肉', '燒臘', '食堂', '小吃', '拉圖爾', '12MINI', 'LADY M', 'LADY-M', '秘食', '墨爾', '炸牛', '爭鮮', '壽司', '涮涮', '鬍鬚張', '無老鍋', '精釀', '三顧茅廬', '冰室', '御園坊', '茗香園', '滷味', '牛肉麵', '拉麵']],
