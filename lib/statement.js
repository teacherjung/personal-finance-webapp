...
const CATEGORY_RULES = [
  ...
  ['旅遊', ['AGODA', 'BOOKING.COM', 'BOOKING ', 'EXPEDIA', 'AIRBNB', 'HOTELS.COM', 'TRIP.COM', 'KKDAY', 'KLOOK', '雄獅', '易遊網', '可樂旅遊', '五福旅遊', '燦星', '旅行社', '訂房', '飯店', '酒店', '旅館', '民宿', '度假村', 'RESORT', 'HOTEL', '溫泉會館']],
  ...
  ['娛樂', ['誠品', '博客來', '威秀', '秀泰', '國賓影城', '電影', 'STEAM', 'PLAYSTATION', 'NINTENDO', '遊戲', 'KTV', '健身']],
...
export async function parseStatementPdf(data, password, issuer = '') {
  ...
  // AGODA 的服務費→旅遊、Netflix 的服務費→訂閱…，而非一律丟其他支出。
