...
const STORE_CANON = [
  ...
  ['林口長庚醫院', /長庚醫療|林口長庚紀念醫/],
  // 三新奧特萊斯林口I館＝三井 OUTLET 林口。**館別會插在公司名中間**（二館登記成「三新二奧特萊斯」，
  // 使用者回報 2026-07-26：三新二奧特萊斯林口II館 沒被換成林口三井）→ 中間允許一個館號字。
  // 一館二館一律同一把鑰匙（使用者定：三井就是三井，館別不分家）。
  ['林口三井', /三新[一二三四五六七八九十\d]?奧特萊斯|三井[Oo]utlet/],
