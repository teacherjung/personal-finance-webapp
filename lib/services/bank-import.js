...
export function assertAiBankReconciled(parsed, db) {
  ...
  if (!t) {
    ...
    if (!totalsFields.length) totalsStatus = TOTALS_CHECK.NOT_PRINTED;   // 三欄全 null＝帳單沒印
  }
