...
export async function syncIb(fetchImpl = fetchFlex) {
  ...
  const secSkippedReasons = { badRow: 0, cancelOrUnknown: 0, missingAccount: 0, missingCurrency: 0, missingCore: 0, unsupportedCurrency: 0 };
  ...
  return { ok: true, updated, created, missing, skippedCurrencies, cashZeroed, cashCollapsed, cashReportMissing, cashDetailMissing, cashDetailIncomplete, cashFromSummary, cashBaseUnsupported, cashSummaryMissing, secTradesAdded, secTradesUpdated, secTradesSkipped, secSkippedReasons, cash: data.cashByCurrency, equity: data.equity, account: data.account };
}
