...
export async function syncIb(fetchImpl = fetchFlex) {
  ...
  return { ok: true, updated, created, missing, skippedCurrencies, cashZeroed, cashCollapsed, cashReportMissing, cashDetailMissing, cashFromSummary, cashBaseUnsupported, cashSummaryMissing, cash: data.cashByCurrency, equity: data.equity, account: data.account };
}
