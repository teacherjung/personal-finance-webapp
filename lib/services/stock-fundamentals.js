...
import { MAX_SEC_RESPONSE_BYTES } from '../parse-limits.js';

// 相容既有匯入名稱；數值的單一真相在 parse-limits.js。
export { MAX_SEC_RESPONSE_BYTES as SEC_MAX_RESPONSE_BYTES } from '../parse-limits.js';
...
function resolvedOptions(opts) {
  ...
  return {
    ...
    maxResponseBytes: merged.maxResponseBytes ?? MAX_SEC_RESPONSE_BYTES,
