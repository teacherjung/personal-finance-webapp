...
export const HEAVY_ROUTES = [
  ...
  // SEC 官方基本面：單一回應可達 25MiB，服務層會整包 JSON.parse——實測 RSS 增加約 118MiB
  //（Codex #371 r2 High：本層最壞預算只剩約 22MiB，與 PDF 並行就越過 512MB）
  '/api/stock-fundamentals/:symbol/refresh',
];
...
export const HEAVY_ROUTES_WITHOUT_BODY = ['/api/ib/sync', '/api/stock-fundamentals/:symbol/refresh'];
