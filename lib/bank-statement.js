 ...
 *    r5#1＝閘 strong、twdAccountsUnverified:0、imported:2、db 兩筆。共同點只有「歧義列進了台幣現金流」。
...
export function makeCurrencyTable() {
  ...
  return {
     ...
     *   才收斂（#504 十四輪學到的同一課）。**收斂的證據有明確射程**：r6 以長度 ≤5 的 257 個模式、
     *   66,049 組配對，對照**長度 ≤8** 的窮舉語言比對零差異＝**有限域內的窮舉，不是無界證明**。
