...
import { squash, parseAmount, splitAmount, accountSuffix, isMaskedAccount, UNKNOWN_CURRENCY, noteAccountCurrency } from './bank-statement.js';
...
export function parseWithRecipe(lines, recipe) {
  ...
  for (const line of lines) {
    ...
    noteAccountCurrency(accountCurrency, masked, currency);   // 同號多幣別＝哨兵（與模板／AI 同一份判準，見 bank-statement.js 的登記器）
