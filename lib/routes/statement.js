...
statementRoutes.post('/api/bank-statement/apply', wrap(async (req, res) => res.json(await applyBankStatement(req.body.data, req.body.password, undefined, { useAi: req.body.useAi === true, aiTicket: typeof req.body.aiTicket === 'string' ? req.body.aiTicket : undefined, aiEngineFactory: makeAnthropicBankEngine }))));
