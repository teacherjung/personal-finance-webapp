...
import { makeAnthropicBankEngine } from '../ai-transport.js';   // P1b-1 真引擎唯一組裝點（本檔全靜態路徑＝外連登記閘可審計）
...
statementRoutes.post('/api/cards/:id/statement/preview', wrap(async (req, res) => res.json(await previewForCard(req.params.id, req.body.data, req.body.password))));
