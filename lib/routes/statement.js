...
statementRoutes.post('/api/bank-statement/preview', wrap(async (req, res) => {
  const opts = { useAi: req.body.useAi === true, aiEngineFactory: makeAnthropicBankEngine };
...
statementRoutes.post('/api/bank-statement/apply', wrap(async (req, res) => res.json(await applyBankStatement(req.body.data, req.body.password, undefined, { ...applyOptsFromBody(req.body), aiEngineFactory: makeAnthropicBankEngine }))));
