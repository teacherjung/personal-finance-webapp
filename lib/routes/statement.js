...
statementRoutes.post('/api/bank-statement/preview', wrap(async (req, res) => res.json(await previewBankStatement(req.body.data, req.body.password, undefined, { useAi: req.body.useAi === true, aiEngineFactory: makeAnthropicBankEngine }))));
