...
import { pickSettingsWritable } from '../schema.js';
...
// 白名單過濾：IB 同步擁有的 lastEquity/income/lastSync 與未知欄位不可由前端寫入
coreRoutes.put('/api/settings', (req, res) => res.json(updateSettings(pickSettingsWritable(req.body))));
