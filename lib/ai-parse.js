  ...
  return {
    ...
    detail: o.detail && typeof o.detail === 'object'
      ? { rowIdent: o.detail.rowIdent, headerOut: o.detail.headerOut, headerIn: o.detail.headerIn,
          ...
          ...(o.detail.headerNote == null ? {} : { headerNote: o.detail.headerNote }),
          ...(Array.isArray(o.detail.headerIgnore) && o.detail.headerIgnore.length ? { headerIgnore: o.detail.headerIgnore } : {}) }
      : undefined,
  };
}
