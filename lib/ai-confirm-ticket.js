...
/** @typedef {{parsed:any, aiModel:string, tenant:string, lines?:any[], suspectRecipeIds?:string[], aiCalls?:number, recipeUse?:{id:string, usedVersion:'current'|'previous', currentMatched?:boolean, usedRecipe:object}, issuedAt?:string, exp:number, timer?:any}} Ticket */
