...
/** @typedef {{parsed:any, aiModel:string, tenant:string, lines?:any[], suspectRecipeIds?:string[], recipeUse?:{id:string, usedVersion:'current'|'previous', currentMatched?:boolean, usedRecipe:object}, issuedAt?:string, exp:number, timer?:any}} Ticket */
