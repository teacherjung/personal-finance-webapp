...
/** @typedef {{parsed:any, aiModel:string, suspectRecipeIds?:string[], recipeUse?:{id:string, usedVersion:'current'|'previous', usedRecipe:object}, issuedAt?:string, exp:number, timer?:any}} Ticket */
