...
export function parseStatement(j, fxToBase = () => null) {   // export 供考題直測旗標語意（hasCashReport/hasCashDetail）
  ...
  return { account, positions, cashByCurrency, hasCashReport, hasCashDetail, cashDetailIncomplete, baseCurrency, baseSummaryCash, statementCount: stmts.length, accountCount, equity, income, trades, period };
}
