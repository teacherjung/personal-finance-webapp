...
export const SEC_METRIC_CANDIDATES = Object.freeze(Object.fromEntries(
  Object.entries(RAW_SEC_METRICS).map(([key, metric]) => [key, Object.freeze({
    ...metric,
    tags: Object.freeze(metric.tags.slice())
  })])
));
...
export function parseSecCompanyFacts(input) {
  ...
  for (const [key, rawDefinition] of Object.entries(SEC_METRIC_CANDIDATES)) {
    const definition = /** @type {{label:string,nature:FactNature,unitKind:UnitKind,tags:readonly string[]}} */ (
      rawDefinition
    );
