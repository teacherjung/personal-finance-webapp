...
export const FIELD_SCHEMA = {
  ...
  accounts: { balance: 'number', type: ['cash', 'investment', 'property', 'insurance-cv', 'other', 'mortgage', 'loan', 'liability', 'creditcard'] },
  ...
  // layer 是枚舉：錯值會讓個股逃過「單一個股上限」等集中度守門（生存守則），故驗證。
  holdings: { quantity: 'number', price: 'number', avgCost: 'number', cost: 'number', layer: ['core', 'satellite', 'stock', 'bond', 'gold'] },
