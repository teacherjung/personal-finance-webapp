...
//
//    📌 **William 2026-07-29 裁決：先不設上限**（`docs/multi-user-launch-plan.md` 裁決⑤）。
//    理由：目前只有他一個人在用、Supabase 已升 Pro（8GB）、Spend Cap 開著。
//    **但這是「知情的空白」，不是已經解決**——`C7 邀真人之前必須回頭處理`。
//    所以這裡只宣稱：帳單列匯入不再是「12 次請求打滿 500MB」的那條捷徑。
//
